...
|---|---|---|
| **Catalog** | [`cholmes/portolan-catalog-trimet`](https://github.com/cholmes/portolan-catalog-trimet) | The generators in [`tools/`](https://github.com/cholmes/portolan-catalog-trimet/tree/main/tools) that build this catalog from TriMet's Shapefiles — the metadata, the column descriptions, the MapLibre styles and these docs. |
| **Data browser** | [`cholmes/trimet-data-browser`](https://github.com/cholmes/trimet-data-browser) | The [data browser](https://cholmes.github.io/trimet-data-browser) itself — map preview, downloads, schema and license. |
...
that is missing — please [open an issue](https://github.com/cholmes/portolan-catalog-trimet/issues) or send a pull
...
[CLAUDE.md](https://github.com/cholmes/portolan-catalog-trimet/blob/main/CLAUDE.md) says which file to edit for
