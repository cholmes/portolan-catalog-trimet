...
GeoParquet file of 287.9 KB in 1 row group(s).
...
readability. Prefix them with [`https://data.source.coop/cholmes/trimet/`](https://source.coop/cholmes/trimet/stops/) to run remotely.
...
- [`route-stops`](https://source.coop/cholmes/trimet/route-stops/AGENTS.md) — the same stops exploded by route and direction; join on `stop_id`
- [`rail-stops`](https://source.coop/cholmes/trimet/rail-stops/AGENTS.md) — rail platforms with real station names, but a *different* id space
- [`transit-centers`](https://source.coop/cholmes/trimet/transit-centers/AGENTS.md) — the 15 major transfer hubs
